...
import org.efire.net.repository.OrderItemRepository;
...
public class OrderItemResourceIntTest {
    ...
    public void createOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getUnitAmount()).isEqualTo(DEFAULT_UNIT_AMOUNT);
    }
    ...
    public void updateOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getUnitAmount()).isEqualTo(UPDATED_UNIT_AMOUNT);
    }
